...
function Stake() {
  ...
  console.log("debug->ohmBalance", ohmBalance);
  ...
  console.log("debug->stakeAllowance", stakeAllowance);
  ...
  const onChangeStake = async (action, isOld) => {
    ...
    console.log("debug_changeStake", isOld);
    ...
    console.log('debug_stake', gweiValue);
  ...
  const hasAllowance = useCallback(
    ...
    console.log('db-stakeAllowance',stakeAllowance, view);
    console.log('hasallowance',unstakeAllowance);
    const isAllowanceDataLoading = (stakeAllowance == null && view === 0) || (unstakeAllowance == null && view === 1);
    console.log('hasallowance',isAllowanceDataLoading);
                ...
                <div className="card-header">
                  ...
                  {address && oldSohmBalance > 0.01 && (
                    ...
                    >
                      ...
                      <Typography>Migrate sWAND!</Typography>
                    </Link>
                  )}
                </div>
              </Grid>
                  ...
                  <Grid container spacing={2} alignItems="flex-end">
                    ...
                    <Grid item xs={12} sm={4} md={4} lg={4}>
                      <div className="stake-index">
                        ...
                        <Typography variant="h4">
                          {currentIndex ? <>{trim(currentIndex, 1)} WAND</> : <Skeleton width="150px" />}
                        </Typography>
                      </div>
                    </Grid>
                  </Grid>
                              ...
                              <Typography variant="body1" className="stake-note" color="textSecondary">
                                {view === 0 ? (
                                  <>
                                    ...
                                    <br />
                                    Please approve Wayland DAO to use your <b>WAND</b> for staking.
                                  </>
                                ) : (
                                  <>
                                    First time unstaking <b>sWAND</b>?
                                    <br />
                                    Please approve Wayland DAO to use your <b>sWAND</b> for unstaking.
                                  </>
                                )}
                              </Typography>
                            </Box>
                    ...
                    <div className={`stake-user-data`}>
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trim(ohmBalance, 4)} WAND</>}
                        </Typography>
                      </div>
