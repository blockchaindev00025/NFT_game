...
export const busd = new StableBond({
  ...
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0x5538a7861f0AbC51D83f030537C1cDDEFF407ff7",
...
export const wand_busd = new LPBond({
  ...
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0xCA5f3C3D9f2Fd6c389D49E15dEad99021E390665",
      reserveAddress: "0x79543345fd417231aa55afe36ff5d9bf7e74c11f",
    },
    [NetworkID.Testnet]: {
  ...
  lpUrl:
    "https://pancakeswap.finance/add/0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56/0xa4d9DCA41f66A84B452585a66183380a51addc24",
});
