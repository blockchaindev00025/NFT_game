...
function OhmMenu() {
  ...
  return (
    ...
    >
      <Button id="ohm-menu-button" size="large" variant="contained" color="secondary" title="WAND" aria-describedby={id}>
        <SvgIcon component={InfoIcon} color="primary" />
        <Typography>WAND</Typography>
      </Button>
                ...
                {isEthereumAPIAvailable ? (
                  <Box className="add-tokens">
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("WAND", WAND_ADDRESS)}>
                        <SvgIcon
                          component={ohmTokenImg}
                          viewBox="0 0 100 100"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">WAND </Typography>
                      </Button>
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("sWAND", SWAND_ADDRESS)}>
                        <SvgIcon
                          component={sOhmTokenImg}
                          viewBox="0 0 100 100"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">sWAND</Typography>
                      </Button>
                    </Box>
                  </Box>
                ) : null}
