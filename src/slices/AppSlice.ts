...
export const loadAppDetails = createAsyncThunk(
  ...
  async ({ networkID, provider }: IBaseAsyncThunk, { dispatch }) => {
    ...
    const sHecMainContract = new ethers.Contract(addresses[networkID].SWAND_ADDRESS as string, sOHMv2, provider);
    const hecContract = new ethers.Contract(addresses[networkID].WAND_ADDRESS as string, ierc20Abi, provider);
    ...
    // currentIndex = currentIndex / 1000000000;
